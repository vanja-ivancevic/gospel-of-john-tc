...
def build_report(path: Path | None = None) -> Path:
    ...
    L = [
        ...
        "corrections, failed its own Pericope-Adulterae test, and is discarded.",
        "- \"Chapter 21 more unstable = later addition\": with real collation + genealogy, ch21 "
        "is among the LEAST unstable chapters and not distinctive after controls.",
        "",
        "## Scope / honesty",
        "- This is a TRANSMISSION-history study. Manuscript data records scribal copying, not "
        "authorial composition; no composition-date or authorship claim is made.",
        "- Münster CBGM is unavailable for John; the genealogy here is our own pre-genealogical "
