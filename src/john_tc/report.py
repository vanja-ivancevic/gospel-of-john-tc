...
def build_report(path: Path | None = None) -> Path:
    ...
    L = [
        ...
        "- Data: IGNTP/INTF ECM apparatus of John (Parker, Morrill & Schmid 2016, CC BY-NC 2.5); "
        "INTF Kurzgefasste Liste / NTVMR (dates); NA28 base text.",
        "- Families: IGNTP *iohannes* + Welsby 2014 (ANTF 45) for Family 1; Perrin 2018 (NTTSD 58) "
        "for Family 13.",
        "- Genealogy/phylogenetics: CBGM (Wasserman & Gurry 2017); Edmondson 2019 (Birmingham PhD) "
        "on the ECM of John, used as the independent-method comparison; open-cbgm and teiphy "
        "(McCollum & Turnbull) for tooling.",
        "- Pericope Adulterae: Knust & Wasserman 2019. Orientation text: World English Bible (PD).",
        "- Methods are standard; the contribution is the reproducible, validation-gated, "
        "family-weighted stability map. Not peer-reviewed.",
    ]
